...
`EDIT-THIS-MathMatrix-beta-255.html`.
...
`beta-manifest.json` and have the single-file copy rebuilt from it.

## Changing what the app says to the child

The tips and the wording for each puzzle live in `var PUZZLES = {` (near line 5093). Each entry has
