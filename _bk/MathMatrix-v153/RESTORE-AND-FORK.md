# 🛟 Putting v153 back, if something goes wrong

This folder is a complete, verified copy of the live site as it stood on
**29 August 2026**. If a later change breaks the live site, everything needed to
undo it is here.
...
| Version in this folder | **v153** |

## Restoring by hand, in a browser

The whole live site is the files in this folder. To put v153 back:

1. Open the repository on **github.com**
2. Click **Add file** → **Upload files**
3. Drag in **`index.html`** from this folder — the untouched original, not
   either of the renamed copies
4. If the pictures or the worker were also changed, drag those in too: `sw.js`,
   `manifest.json`, the 8 `cheat-*` files, `bgm-monkeys.mp3`, the 3 `icon-*`
   files
5. Commit
...
1. Open **https://kidsmathsmatrixpuzzle.github.io/** in a private/incognito
   window, so you are not shown your own cached copy
...
## Forking: a parallel version that does not disturb the live one

If you want to try something without any risk to the live site, do not edit the
live repository at all. Publish a **second** copy from a different account and
work there. Full steps are in `NEW-REPOSITORY.md`.
...
what the live site was serving on 29 August 2026. `check-backup-bundle.js`,
kept with the project, checks all of them at once and also confirms the
editable copy is identical to the live page.
