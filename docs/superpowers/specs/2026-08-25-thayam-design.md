...
Status: **design agreed in discussion, layout mocked up, not yet built.** Everything below is what has been confirmed across this design conversation with Raja. Nothing here is implemented in `beta.html` yet.
